...
/// Body of a device DELETE request. Optional: an empty body asks for a managed
/// removal, which is the sensible default.
...
mod tests {
    ...
    fn test_parse_unplug_device_request() {
        // No body, an empty object and an explicit false all ask for a managed
        // removal.
